  ...
  return (
    <div className="min-h-screen bg-mesh">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-20">
        ...
        <button
          onClick={() => router.back()}
          className="inline-flex items-center gap-2 text-purple-400/70 hover:text-purple-300 transition-colors mb-6 text-sm font-medium"
        >
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6 animate-fade-in-delay-1">
          <div className="flex items-center gap-3">
            <label className="text-sm text-purple-200/50">Date</label>
            <input
              type="date"
              value={selectedDate}
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-emerald-500/60 ring-2 ring-emerald-500/20"></div>
              <span className="text-xs text-white/50">Available <span className="text-emerald-400 font-semibold">{availableCount}</span></span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-amber-500/60 ring-2 ring-amber-500/20"></div>
              <span className="text-xs text-white/50">Reserved <span className="text-amber-400 font-semibold">{reservedCount}</span></span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-red-500/60 ring-2 ring-red-500/20"></div>
              <span className="text-xs text-white/50">Blocked <span className="text-red-400 font-semibold">{blockedCount}</span></span>
            </div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="animate-fade-in-delay-2">
            <div className="glass-card rounded-2xl p-4 inline-block hover:transform-none">
              <div className="text-xs text-purple-300/30 font-medium uppercase tracking-widest mb-3 px-1">
                Floor Plan
              </div>
              <div
            ...
            <p className="text-xs text-purple-200/20 mt-3">
